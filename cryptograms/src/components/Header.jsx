    ...
    return (
        <header className="flex-none flex justify-between items-center px-4 py-3 border-b border-cyber-cyan/30 bg-cyber-surface z-10 shadow-sm">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-xl font-bold text-cyber-cyan leading-none">Cryptogram</h1>
                    <p className="hidden sm:block text-cyber-text/60 text-xs mt-1">Decipher the quote</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="p-2 rounded-full hover:bg-cyber-cyan/10 text-cyber-text transition-colors"
